...
# Jak policzyć liczbę poziomów mając liczbę puszek?
# - załóżmy, że mamy 5 puszek
# - możemy budować wieże od góry i sprawdzać czy wystarczy puszek na następny (pełny) poziom
...
# za każdą kolejną "iteracją" odejmujemy od posiadanej liczby puszek te wykorzystane (bieżący poziom - patrz obserwacja wyżej) i zwiększamy bieżący poziom
# zagnieżdżanie trwa dopóki z pozostałych puszek da się zbudować bieżący poziom (liczba puszek jest większa lub równa od bieżącego poziomu, bo tyle puszek trzeba, aby ułożyć cały rząd puszek na danym poziomie)
